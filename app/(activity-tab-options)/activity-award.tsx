          ...
          <TouchableOpacity
            onPress={() => {
              if (navigation.canGoBack()) {
                ...
                // Option A: Navigate to a specific fallback screen
                navigation.navigate("Home");

                // Option B: Do nothing or show a message
                console.log("No screens to go back to");
              }
            }}
          >
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {dailyTasks.map((item, index) => (
            <View key={index} style={styles.card}>
              ...
              <View style={styles.descBox}>
                <Text style={styles.desc}>
                  Members must place bets on the &quot;SLOTS&quot; game &
                  complete the deposit, also meet both the minimum betting and
                  deposit requirements within a day to complete the task and
                  receive the reward.
                </Text>
              </View>
