  ...
  return (
    <View style={styles.emptyWrapper}>
      <View style={styles.illustration}>
        {/* Background hills */}
        <View style={[styles.hill, { width: 110, height: 52, left: 4,  bottom: 0 }]} />
        <View style={[styles.hill, { width:  75, height: 38, right: 8, bottom: 0 }]} />
        ...
        {/* Right tree (smaller) */}
        <View style={[styles.treeWrap, { right: 28, bottom: 8, transform: [{ scale: 0.75 }] }]}>
          <View style={styles.treeTop} />
          <View style={styles.treeTrunk} />
        </View>
