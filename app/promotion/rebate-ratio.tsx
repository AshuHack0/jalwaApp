...
type TabKey = 'Lottery' | 'Casino' | 'Sports' | 'Rummy';
...
const LOTTERY_LEVELS: RebateLevel[] = [
  { level: 0,  rates: ['0.6%',    '0.18%',    '0.054%',     '0.0162%',    '0.00486%',   '0.001458%'  ] },
  { level: 1,  rates: ['0.7%',    '0.245%',   '0.08575%',   '0.030012%',  '0.0105004%', '0.003677%'  ] },
  { level: 2,  rates: ['0.75%',   '0.28125%', '0.105469%',  '0.039551%',  '0.014832%',  '0.005562%'  ] },
  { level: 3,  rates: ['0.8%',    '0.32%',    '0.128%',     '0.0512%',    '0.02048%',   '0.008192%'  ] },
  { level: 4,  rates: ['0.85%',   '0.36125%', '0.153531%',  '0.065251%',  '0.027732%',  '0.011786%'  ] },
  { level: 5,  rates: ['0.9%',    '0.405%',   '0.18225%',   '0.082013%',  '0.036906%',  '0.016608%'  ] },
  { level: 6,  rates: ['1%',      '0.5%',     '0.25%',      '0.125%',     '0.0625%',    '0.03125%'   ] },
  { level: 7,  rates: ['1.1%',    '0.605%',   '0.33275%',   '0.183013%',  '0.100657%',  '0.055361%'  ] },
  { level: 8,  rates: ['1.2%',    '0.72%',    '0.432%',     '0.2592%',    '0.15552%',   '0.093312%'  ] },
  { level: 9,  rates: ['1.3%',    '0.845%',   '0.54925%',   '0.357013%',  '0.232058%',  '0.150838%'  ] },
  { level: 10, rates: ['1.4%',    '0.98%',    '0.686%',     '0.4802%',    '0.33614%',   '0.235298%'  ] },
];
