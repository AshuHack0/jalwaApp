...
// ── Stat Cell ─────────────────────────────────────────────────────────────────
function StatCell({ value, label, borderRight = false, borderBottom = false }: {
  value: string;
  label: string;
  borderRight?: boolean;
...
export default function SubordinateDataScreen() {
  ...
  const DATE_OPTIONS = ['2026-03-08', '2026-03-07', '2026-03-06', '2026-03-05', '2026-03-04'];

  const stats = [
    { value: '0', label: 'Deposit number',                    borderRight: true,  borderBottom: true  },
    { value: '0', label: 'Deposit amount',                    borderRight: false, borderBottom: true  },
    { value: '0', label: 'Number of bettors',                 borderRight: true,  borderBottom: true  },
    { value: '0', label: 'Total bet',                         borderRight: false, borderBottom: true  },
    { value: '0', label: 'Number of people making first deposit', borderRight: true,  borderBottom: false },
    { value: '0', label: 'First deposit amount',              borderRight: false, borderBottom: false },
  ];
      ...
      <ThemedView style={[styles.container, { paddingBottom: insets.bottom }]}>
        ...
        >
          ...
          <View style={styles.filterRow}>
            <View style={{ flex: 1 }}>
              <Dropdown value={filterType} options={TYPE_OPTIONS} onSelect={setFilterType} />
            </View>
            <View style={{ flex: 1 }}>
              <Dropdown value={filterDate} options={DATE_OPTIONS} onSelect={setFilterDate} />
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  scroll:    { flex: 1 },
  scrollContent: { paddingHorizontal: 12, paddingTop: 10, paddingBottom: 40, gap: 10 },
