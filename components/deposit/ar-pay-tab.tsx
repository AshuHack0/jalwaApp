    ...
    <>
      ...
      <View style={styles.section}>
        <View style={styles.arNotActivatedRow}>
          <Image source={{ uri: "https://jalwaimg.jalwa-jalwa.com/Jalwa/payNameIcon/payNameIcon_202503171657306civ.png" }} style={{ width: 40, height: 40 }} />
          ...
          <TouchableOpacity onPress={handleActivate}>
            <LinearGradient colors={["#7AFEC3", "#02AFB6"]} start={{ x: 0.5, y: 0 }} end={{ x: 0.5, y: 1 }} style={styles.arActivateBtn}>
        ...
        <View style={styles.arInfoCard}>
          <View style={styles.sectionHeader}>
            <Svg width={20} height={18} viewBox="0 0 46 41" fill="none">
              <Path d="M9.1449 6.3253C4.09234 6.3253 0 10.4176 0 15.4702C0 15.0129 0 9.98325 0 9.98325C0 4.95356 4.57245 0.5 9.60214 0.5H26.7717C30.7404 0.5 34.0635 2.66533 34.966 6.18459C29.2637 6.18459 12.8029 6.3253 9.1449 6.3253Z" fill="#7AFEC3" />
              <Path opacity={0.4} d="M35.3908 20.0382C34.2476 21.1585 33.6989 22.8503 34.1562 24.5649C34.7277 26.6911 36.8311 28.04 39.0258 28.04H42.981V31.355C42.981 36.4076 38.8887 40.4999 33.8361 40.4999H9.1449C4.09234 40.4999 0 36.4076 0 31.355V15.3514C0 10.2989 4.09234 6.20654 9.1449 6.20654C9.1449 6.20654 28.8064 6.20654 33.8361 6.20654C38.8658 6.20654 42.981 10.3217 42.981 15.3514V18.6665H38.6829C37.4026 18.6665 36.2367 19.1694 35.3908 20.0382Z" fill="#7AFEC3" />
              <Path d="M45.7244 21.0072V25.7169C45.7244 26.9971 44.6727 28.0488 43.3696 28.0488H38.9572C36.488 28.0488 34.2247 26.2427 34.0189 23.7736C33.8817 22.3333 34.4304 20.9844 35.3906 20.047C36.2365 19.1783 37.4025 18.6753 38.6828 18.6753H43.3696C44.6727 18.6753 45.7244 19.727 45.7244 21.0072Z" fill="#7AFEC3" />
              <Path d="M25.0116 30.5596H29.2638L21.4457 15.9277H16.7583L10.0596 30.5596H20.8946L22.2895 28.1478L20.5727 25.1688L19.2851 27.2674H15.5578L19.0795 19.8296L25.0116 30.5596Z" fill="#7AFEC3" />
            </Svg>
          ...
          <TouchableOpacity onPress={handleActivate}>
            <LinearGradient colors={["#00ECBE", "#00ECBE"]} start={{ x: 0.5, y: 0 }} end={{ x: 0.5, y: 1 }} style={styles.arActivateBtnFull}>
              <ThemedText style={styles.arActivateBtnText}>activate AR wallet</ThemedText>
            </LinearGradient>
          </TouchableOpacity>
        </View>
